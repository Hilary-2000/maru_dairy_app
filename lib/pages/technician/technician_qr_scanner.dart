...
class TechnicianQrScanner extends StatefulWidget {
  const TechnicianQrScanner({super.key});

  @override
  State<TechnicianQrScanner> createState() => _TechnicianQrScannerState();
}

class _TechnicianQrScannerState extends State<TechnicianQrScanner> {

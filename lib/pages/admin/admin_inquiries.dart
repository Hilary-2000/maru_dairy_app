    ...
    return SafeArea(child: LayoutBuilder(
      builder: (context, constraints) {
        ...
        return NotificationListener<ScrollNotification>(
          onNotification: (ScrollNotification scrollInfo){ // Check if the scroll position is at the top
              if (scrollInfo.metrics.atEdge && scrollInfo.metrics.pixels == 0) { // Call your reload function
                increase++;
                if(increase >= 30 && !load_inquiries){
                  increase = 0;
                  getChats();
                }
              }
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  width: width,
                  child: Center(
                    child: load_inquiries ? CircularProgressIndicator(
                      color: customs.primaryColor,
                    ) : Text("Scroll down to reload!", style: customs.primaryTextStyle(size: 10),),
                  ),
                )
              )
            ],

...
class SuperAdminDetails extends StatefulWidget {
  const SuperAdminDetails({super.key});

  @override
  State<SuperAdminDetails> createState() => _SuperAdminDetailsState();
}

class _SuperAdminDetailsState extends State<SuperAdminDetails> {
  CustomThemes customs = CustomThemes();
  Map<String, dynamic>? args;
  List<Color> bg_color = [];
  int index = 0;
  var superAdministratorData = null;
  bool loading = false;
  bool _init = false;
  ...
  Future<void> getTechnicianData() async {
    ...
    if(customs.isValidJson(jsonEncode(args))){
      ...
      if(customs.isValidJson(response)){
        ...
        if(res['success']){
          setState(() {
            superAdministratorData = res['super_admin'];
          });
        }else{
          setState(() {
            superAdministratorData = null;
          });
    ...
    return Scaffold(
                        ...
                        children: [
                          Container(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    Text("View Super-Administrator Details", style: customs.secondaryTextStyle(size: 15, fontweight: FontWeight.bold),),
                                    Hero(
                                      tag: _heroAddTodo,
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Text(
                                                superAdministratorData != null ? customs.toCamelCase(superAdministratorData['fullname'] ?? "N/A") : "N/A",
                                              ...
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    color: (superAdministratorData  != null ? customs.toCamelCase((superAdministratorData['status'] ?? "0").toString()) : "0") == "1" ? customs.successColor : customs.dangerColor,
                                                    borderRadius: BorderRadius.circular(2)
                                                ),
                                                child: Text( (superAdministratorData  != null ? customs.toCamelCase((superAdministratorData['status'] ?? "0").toString()) : "0") == "1" ?  "Active" : "In-active", style:customs.whiteTextStyle(size: 10, fontweight: FontWeight.bold)),
                                              )
                                            ],
                                          ),
                                        ),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  superAdministratorData != null ? superAdministratorData['phone_number'] ?? "N/A" : "N/A",
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  superAdministratorData != null ? superAdministratorData['email'] ?? "N/A" : "N/A",
                                  style: customs.secondaryTextStyle(size: 16),
                                ),
                                Divider(
                                  color: customs.secondaryShade_2,
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  superAdministratorData != null ? customs.toCamelCase(superAdministratorData['residence'] ?? "N/A") : "N/A",
                                  style: customs.secondaryTextStyle(size: 16),
                                ),
                                Divider(
                                  color: customs.secondaryShade_2,
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  superAdministratorData != null ? customs.toCamelCase(superAdministratorData['username'] ?? "N/A") : "N/A",
                                  style: customs.secondaryTextStyle(size: 16),
                                ),
                                Divider(
                                  color: customs.secondaryShade_2,
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  superAdministratorData != null ? customs.toCamelCase(superAdministratorData['national_id'] ?? "N/A") : "N/A",
                                  style: customs.secondaryTextStyle(size: 16),
                                ),
                                Divider(
                                  color: customs.secondaryShade_2,
      ...
      floatingActionButton: CircleAvatar(
        ...
        child: IconButton(
          ...
          onPressed: () async {
            await Navigator.pushNamed(context, "/edit_super_admin_details", arguments: {"index": index, "super_admin_id": (superAdministratorData != null ? (superAdministratorData['user_id'] ?? "0") : "0")});
            getTechnicianData();
          },
        ),
      ),
...
class _AddTodoPopupCard extends StatefulWidget {
  ...
  _AddTodoPopupCard({Key? key, required this.super_administrator_data}) : super(key: key);
              ...
              child: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Text("Are you sure you want to delete \"${customThemes.toCamelCase(widget.super_administrator_data['fullname'])}\" ?", style: customThemes.darkTextStyle(size: 15, fontweight: FontWeight.bold),),
                      SizedBox(height: 10,),

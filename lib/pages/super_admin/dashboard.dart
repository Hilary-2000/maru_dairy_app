...
class _SuperAdminDashState extends State<SuperAdminDash> {
  CustomThemes customs = CustomThemes();
  int index = 0;
  String drop_down = "7";
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              "Goodmorning,",
                              style: customs.primaryTextStyle(size: width * 0.04, fontweight: FontWeight.normal),
                            ),
                            SizedBox(height: height * 0.005,),
                            Text(
                              "Hillary Ngige",
                              style: customs.successTextStyle(size: width * 0.05, fontweight: FontWeight.bold),
                            )
                          ],
                        ),
                      ),
